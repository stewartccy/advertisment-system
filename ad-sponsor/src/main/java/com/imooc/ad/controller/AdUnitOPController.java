...
public class AdUnitOPController {
    ...
    public AdUnitResponse createUnit(@RequestBody AdUnitResponse adUnitResponse)throws AdException{
        log.info("ad-sponsor:createUnit -> {}", JSON.toJSONString(adUnitResponse));
        return adUnitService.createUnit(adUnitResponse);
    }
